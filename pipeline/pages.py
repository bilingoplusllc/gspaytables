"""Структурные страницы GS Pay Tables: главная, грейды, правила, служебные.
...
def about(shell) -> str:
    ...
    B.append('<p>GS Pay Tables publishes the federal General Schedule pay tables with the parts '
    ...
    return shell("About GS Pay Tables — how the numbers are built and checked",
                 "GS Pay Tables recomputes every federal pay rate from the OPM source tables "
...
def not_found(shell) -> str:
    ...
    return shell("Page not found — GS Pay Tables",
...
independently recomputed and matched to the published figures.</figcaption>
    ...
    B.append('<p>Roughly a third of federal employees are not paid from this table at '
             ...
             'added together.</p>')
    return shell(f"GS Pay Scale {year} — all 15 grades and what they pay | GS Pay Tables",
...
def contact(shell, contact_email: str, owner: str) -> str:
    ...
    B = ['<ol class="crumbs"><li><a href="/">All localities</a></li>'
         ...
         f'<p>GS Pay Tables is published by {owner}, a limited liability company registered '
         ...
         'advise you. GS Pay Tables publishes public federal data and arithmetic performed '
    ...
    return shell("Contact GS Pay Tables",
                 "How to reach GS Pay Tables, how to report a figure you think is wrong, "
...
def methodology(T: dict, R: dict, shell, money, owner: str, contact_email: str) -> str:
    ...
    B = ['<ol class="crumbs"><li><a href="/">All localities</a></li>'
         ...
         f'<p class="q-lead">GS Pay Tables is published by {owner}, a limited liability '
         ...
         'so.</p>',
         f'<p>And nothing here is advice. GS Pay Tables publishes public federal data and '
